...
class DmfControlBoardPlugin(SingletonPlugin):
    ...
    def on_app_init(self, app):
        ...
        menu_item.connect("activate", self.on_show_window)
        menu_item.show()
        ...
        try:
            ...
            self.app.main_window_controller.label_connection_status.set_text(
    ...
    def on_show_window(self, widget, data=None):
        """
